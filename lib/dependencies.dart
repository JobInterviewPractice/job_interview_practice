...
import 'feature/setting/domain/usecases/set_only_week_question_use_case.dart';
...
void _setupSettingsDependencies() {
  ...
  serviceLocator
      .registerFactory<GetOnlyWeekQuestionUseCase>(() => GetOnlyWeekQuestionUseCase(repository: serviceLocator()));
  serviceLocator
      .registerFactory<SetNumberOfQuestionUseCase>(() => SetNumberOfQuestionUseCase(repository: serviceLocator()));
  serviceLocator
      .registerFactory<SetOnlyWeekQuestionUseCase>(() => SetOnlyWeekQuestionUseCase(repository: serviceLocator()));
  ...
  serviceLocator.registerFactory<SettingsSwitchBloc>(() =>
      SettingsSwitchBloc(getOnlyWeekQuestionUseCase: serviceLocator(), setOnlyWeekQuestionUseCase: serviceLocator()));
}
